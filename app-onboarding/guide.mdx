...
2. **Fill Configuration & Capability**
  ...
  - Use the [JSON Schema](https://github.com/chargebee/cb-provider-spi/blob/main/spec/capabilities/tax-provider.schema.json) for reference.
