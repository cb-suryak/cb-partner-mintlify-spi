...
Below is the structure of authorization header that will be passed from chargebee_app to tax_provider_app

```json
{
--header 'Authorization: 
{
  "client_id": "client_id_partnerX", 
  "client_secret": "client_secret_partnerX",
  "merchant_id": "merchant_id_partnerX",
  "company_code": company_code_partnerX",
  "host": "https://sandboxap2.partnerX.com//"
}
'
}