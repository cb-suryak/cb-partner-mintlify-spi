...
/**
 * API tests for LocationValidateApi
 */
@Disabled
public class LocationValidateApiTest {

    private final LocationValidateApi api = new LocationValidateApi();
     ...
     */
    @Test
    public void locationValidateTest() throws ApiException {
        LocationValidationEvidence locationValidationEvidence = null;
        LocationValidateResponse response = api.locationValidate(locationValidationEvidence);
