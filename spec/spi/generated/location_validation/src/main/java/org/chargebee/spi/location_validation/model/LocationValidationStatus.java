 ...
 */
@JsonAdapter(LocationValidationStatus.Adapter.class)
public enum LocationValidationStatus {
  ...
  public static class Adapter extends TypeAdapter<LocationValidationStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final LocationValidationStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LocationValidationStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LocationValidationStatus.fromValue(value);
    }
  }
}
