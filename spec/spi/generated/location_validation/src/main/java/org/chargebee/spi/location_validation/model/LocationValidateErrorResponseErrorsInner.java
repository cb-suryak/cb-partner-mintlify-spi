...
import org.chargebee.spi.location_validation.model.ErrorCode;
...
public class LocationValidateErrorResponseErrorsInner {
  ...
  * @throws IOException if the JSON Element is invalid with respect to LocationValidateErrorResponseErrorsInner
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LocationValidateErrorResponseErrorsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LocationValidateErrorResponseErrorsInner is not found in the empty JSON string", LocationValidateErrorResponseErrorsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LocationValidateErrorResponseErrorsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LocationValidateErrorResponseErrorsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LocationValidateErrorResponseErrorsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocationValidateErrorResponseErrorsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocationValidateErrorResponseErrorsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocationValidateErrorResponseErrorsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocationValidateErrorResponseErrorsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<LocationValidateErrorResponseErrorsInner>() {
           @Override
           public void write(JsonWriter out, LocationValidateErrorResponseErrorsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LocationValidateErrorResponseErrorsInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LocationValidateErrorResponseErrorsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LocationValidateErrorResponseErrorsInner
  * @throws IOException if the JSON string is invalid with respect to LocationValidateErrorResponseErrorsInner
  */
  public static LocationValidateErrorResponseErrorsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocationValidateErrorResponseErrorsInner.class);
  }

 /**
  * Convert an instance of LocationValidateErrorResponseErrorsInner to an JSON string
  *
  * @return JSON string
  */
