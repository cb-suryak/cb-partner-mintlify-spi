...
/**
 * API tests for TaxEstimateApi
 */
@Disabled
public class TaxEstimateApiTest {

    private final TaxEstimateApi api = new TaxEstimateApi();
    ...
    public void estimateTaxesTest() throws ApiException {
        TaxEstimationRequest taxEstimationRequest = null;
        TaxEstimationResponse response = api.estimateTaxes(taxEstimationRequest);
