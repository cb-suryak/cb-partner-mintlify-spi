...
public class TaxEstimateApi {
     ...
     */
    public okhttp3.Call estimateTaxesCall(TaxEstimationRequest taxEstimationRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call estimateTaxesValidateBeforeCall(TaxEstimationRequest taxEstimationRequest, final ApiCallback _callback) throws ApiException {
        return estimateTaxesCall(taxEstimationRequest, _callback);
     ...
     */
    public TaxEstimationResponse estimateTaxes(TaxEstimationRequest taxEstimationRequest) throws ApiException {
        ApiResponse<TaxEstimationResponse> localVarResp = estimateTaxesWithHttpInfo(taxEstimationRequest);
     ...
     */
    public ApiResponse<TaxEstimationResponse> estimateTaxesWithHttpInfo(TaxEstimationRequest taxEstimationRequest) throws ApiException {
        okhttp3.Call localVarCall = estimateTaxesValidateBeforeCall(taxEstimationRequest, null);
     ...
     */
    public okhttp3.Call estimateTaxesAsync(TaxEstimationRequest taxEstimationRequest, final ApiCallback<TaxEstimationResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = estimateTaxesValidateBeforeCall(taxEstimationRequest, _callback);
        Type localVarReturnType = new TypeToken<TaxEstimationResponse>(){}.getType();
