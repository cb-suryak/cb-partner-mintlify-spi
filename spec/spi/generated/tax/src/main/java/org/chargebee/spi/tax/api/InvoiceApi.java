...
public class InvoiceApi {
     ...
     */
    public okhttp3.Call commitInvoiceCall(String invoiceId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call commitInvoiceValidateBeforeCall(String invoiceId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'invoiceId' is set
        if (invoiceId == null) {
            throw new ApiException("Missing the required parameter 'invoiceId' when calling commitInvoice(Async)");
        }

        return commitInvoiceCall(invoiceId, _callback);
     ...
     */
    public void commitInvoice(String invoiceId) throws ApiException {
        commitInvoiceWithHttpInfo(invoiceId);
    }
     ...
     */
    public ApiResponse<Void> commitInvoiceWithHttpInfo(String invoiceId) throws ApiException {
        okhttp3.Call localVarCall = commitInvoiceValidateBeforeCall(invoiceId, null);
     ...
     */
    public okhttp3.Call commitInvoiceAsync(String invoiceId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = commitInvoiceValidateBeforeCall(invoiceId, _callback);
     ...
     */
    public okhttp3.Call createInvoiceCall(InvoiceRequest invoiceRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createInvoiceValidateBeforeCall(InvoiceRequest invoiceRequest, final ApiCallback _callback) throws ApiException {
        return createInvoiceCall(invoiceRequest, _callback);
    ...
    public Invoice createInvoice(InvoiceRequest invoiceRequest) throws ApiException {
        ApiResponse<Invoice> localVarResp = createInvoiceWithHttpInfo(invoiceRequest);
     ...
     */
    public ApiResponse<Invoice> createInvoiceWithHttpInfo(InvoiceRequest invoiceRequest) throws ApiException {
        okhttp3.Call localVarCall = createInvoiceValidateBeforeCall(invoiceRequest, null);
     ...
     */
    public okhttp3.Call createInvoiceAsync(InvoiceRequest invoiceRequest, final ApiCallback<Invoice> _callback) throws ApiException {

        okhttp3.Call localVarCall = createInvoiceValidateBeforeCall(invoiceRequest, _callback);
        Type localVarReturnType = new TypeToken<Invoice>(){}.getType();
     ...
     */
    public okhttp3.Call fetchInvoiceCall(String invoiceId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call fetchInvoiceValidateBeforeCall(String invoiceId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'invoiceId' is set
        if (invoiceId == null) {
            throw new ApiException("Missing the required parameter 'invoiceId' when calling fetchInvoice(Async)");
        }

        return fetchInvoiceCall(invoiceId, _callback);
     ...
     */
    public Invoice fetchInvoice(String invoiceId) throws ApiException {
        ApiResponse<Invoice> localVarResp = fetchInvoiceWithHttpInfo(invoiceId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Invoice> fetchInvoiceWithHttpInfo(String invoiceId) throws ApiException {
        okhttp3.Call localVarCall = fetchInvoiceValidateBeforeCall(invoiceId, null);
        Type localVarReturnType = new TypeToken<Invoice>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call fetchInvoiceAsync(String invoiceId, final ApiCallback<Invoice> _callback) throws ApiException {

        okhttp3.Call localVarCall = fetchInvoiceValidateBeforeCall(invoiceId, _callback);
        Type localVarReturnType = new TypeToken<Invoice>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call voidInvoiceCall(String invoiceId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call voidInvoiceValidateBeforeCall(String invoiceId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'invoiceId' is set
        if (invoiceId == null) {
            throw new ApiException("Missing the required parameter 'invoiceId' when calling voidInvoice(Async)");
        }

        return voidInvoiceCall(invoiceId, _callback);
     ...
     */
    public void voidInvoice(String invoiceId) throws ApiException {
        voidInvoiceWithHttpInfo(invoiceId);
    }
     ...
     */
    public ApiResponse<Void> voidInvoiceWithHttpInfo(String invoiceId) throws ApiException {
        okhttp3.Call localVarCall = voidInvoiceValidateBeforeCall(invoiceId, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call voidInvoiceAsync(String invoiceId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = voidInvoiceValidateBeforeCall(invoiceId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
