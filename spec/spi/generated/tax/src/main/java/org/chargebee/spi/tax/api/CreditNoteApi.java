...
public class CreditNoteApi {
     ...
     */
    public okhttp3.Call commitCreditNoteCall(String creditNoteId, String invoiceId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call commitCreditNoteValidateBeforeCall(String creditNoteId, String invoiceId, final ApiCallback _callback) throws ApiException {
        ...
        return commitCreditNoteCall(creditNoteId, invoiceId, _callback);
     ...
     */
    public void commitCreditNote(String creditNoteId, String invoiceId) throws ApiException {
        commitCreditNoteWithHttpInfo(creditNoteId, invoiceId);
    }
     ...
     */
    public ApiResponse<Void> commitCreditNoteWithHttpInfo(String creditNoteId, String invoiceId) throws ApiException {
        okhttp3.Call localVarCall = commitCreditNoteValidateBeforeCall(creditNoteId, invoiceId, null);
     ...
     */
    public okhttp3.Call commitCreditNoteAsync(String creditNoteId, String invoiceId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = commitCreditNoteValidateBeforeCall(creditNoteId, invoiceId, _callback);
     ...
     */
    public okhttp3.Call createCreditNoteCall(CreditNoteRequest creditNoteRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createCreditNoteValidateBeforeCall(CreditNoteRequest creditNoteRequest, final ApiCallback _callback) throws ApiException {
        return createCreditNoteCall(creditNoteRequest, _callback);
     ...
     */
    public CreditNote createCreditNote(CreditNoteRequest creditNoteRequest) throws ApiException {
        ApiResponse<CreditNote> localVarResp = createCreditNoteWithHttpInfo(creditNoteRequest);
     ...
     */
    public ApiResponse<CreditNote> createCreditNoteWithHttpInfo(CreditNoteRequest creditNoteRequest) throws ApiException {
        okhttp3.Call localVarCall = createCreditNoteValidateBeforeCall(creditNoteRequest, null);
     ...
     */
    public okhttp3.Call createCreditNoteAsync(CreditNoteRequest creditNoteRequest, final ApiCallback<CreditNote> _callback) throws ApiException {

        okhttp3.Call localVarCall = createCreditNoteValidateBeforeCall(creditNoteRequest, _callback);
        Type localVarReturnType = new TypeToken<CreditNote>(){}.getType();
     ...
     */
    public okhttp3.Call fetchCreditNoteCall(String creditNoteId, String invoiceId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call fetchCreditNoteValidateBeforeCall(String creditNoteId, String invoiceId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'creditNoteId' is set
        if (creditNoteId == null) {
            throw new ApiException("Missing the required parameter 'creditNoteId' when calling fetchCreditNote(Async)");
        }

        return fetchCreditNoteCall(creditNoteId, invoiceId, _callback);
     ...
     */
    public CreditNote fetchCreditNote(String creditNoteId, String invoiceId) throws ApiException {
        ApiResponse<CreditNote> localVarResp = fetchCreditNoteWithHttpInfo(creditNoteId, invoiceId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CreditNote> fetchCreditNoteWithHttpInfo(String creditNoteId, String invoiceId) throws ApiException {
        okhttp3.Call localVarCall = fetchCreditNoteValidateBeforeCall(creditNoteId, invoiceId, null);
        Type localVarReturnType = new TypeToken<CreditNote>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call fetchCreditNoteAsync(String creditNoteId, String invoiceId, final ApiCallback<CreditNote> _callback) throws ApiException {

        okhttp3.Call localVarCall = fetchCreditNoteValidateBeforeCall(creditNoteId, invoiceId, _callback);
        Type localVarReturnType = new TypeToken<CreditNote>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call voidCreditNoteCall(String creditNoteId, String invoiceId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call voidCreditNoteValidateBeforeCall(String creditNoteId, String invoiceId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'creditNoteId' is set
        if (creditNoteId == null) {
            throw new ApiException("Missing the required parameter 'creditNoteId' when calling voidCreditNote(Async)");
        }

        return voidCreditNoteCall(creditNoteId, invoiceId, _callback);
     ...
     */
    public void voidCreditNote(String creditNoteId, String invoiceId) throws ApiException {
        voidCreditNoteWithHttpInfo(creditNoteId, invoiceId);
    }
     ...
     */
    public ApiResponse<Void> voidCreditNoteWithHttpInfo(String creditNoteId, String invoiceId) throws ApiException {
        okhttp3.Call localVarCall = voidCreditNoteValidateBeforeCall(creditNoteId, invoiceId, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call voidCreditNoteAsync(String creditNoteId, String invoiceId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = voidCreditNoteValidateBeforeCall(creditNoteId, invoiceId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
