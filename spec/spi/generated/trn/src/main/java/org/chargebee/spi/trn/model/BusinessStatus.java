 ...
 */
@JsonAdapter(BusinessStatus.Adapter.class)
public enum BusinessStatus {
  ...
  public static class Adapter extends TypeAdapter<BusinessStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final BusinessStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public BusinessStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return BusinessStatus.fromValue(value);
    }
  }
}
