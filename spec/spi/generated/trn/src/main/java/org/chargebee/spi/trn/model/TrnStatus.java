 ...
 */
@JsonAdapter(TrnStatus.Adapter.class)
public enum TrnStatus {
  ...
  public static class Adapter extends TypeAdapter<TrnStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final TrnStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TrnStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TrnStatus.fromValue(value);
    }
  }
}
