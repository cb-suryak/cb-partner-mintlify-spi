...
public class BasicErrorResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to BasicErrorResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BasicErrorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BasicErrorResponse is not found in the empty JSON string", BasicErrorResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BasicErrorResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BasicErrorResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BasicErrorResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BasicErrorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BasicErrorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BasicErrorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BasicErrorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BasicErrorResponse>() {
           @Override
           public void write(JsonWriter out, BasicErrorResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BasicErrorResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BasicErrorResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BasicErrorResponse
  * @throws IOException if the JSON string is invalid with respect to BasicErrorResponse
  */
  public static BasicErrorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BasicErrorResponse.class);
  }

 /**
  * Convert an instance of BasicErrorResponse to an JSON string
  *
  * @return JSON string
  */
