...
public class TrnValidateBatchRequest {
  ...
  private List<TrnValidateRequest> trns = new ArrayList<>();
  ...
  **/
  ...
  public TrnValidateBatchRequest trns(List<TrnValidateRequest> trns) {
  ...
  **/
  ...
  public List<TrnValidateRequest> getTrns() {
    return trns;
  }


  public void setTrns(List<TrnValidateRequest> trns) {
    this.trns = trns;
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to TrnValidateBatchRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrnValidateBatchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrnValidateBatchRequest is not found in the empty JSON string", TrnValidateBatchRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrnValidateBatchRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrnValidateBatchRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrnValidateBatchRequest.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraytrns.size(); i++) {
        TrnValidateRequest.validateJsonElement(jsonArraytrns.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrnValidateBatchRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrnValidateBatchRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrnValidateBatchRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrnValidateBatchRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TrnValidateBatchRequest>() {
           @Override
           public void write(JsonWriter out, TrnValidateBatchRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrnValidateBatchRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TrnValidateBatchRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TrnValidateBatchRequest
  * @throws IOException if the JSON string is invalid with respect to TrnValidateBatchRequest
  */
  public static TrnValidateBatchRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrnValidateBatchRequest.class);
  }

 /**
  * Convert an instance of TrnValidateBatchRequest to an JSON string
  *
  * @return JSON string
  */
