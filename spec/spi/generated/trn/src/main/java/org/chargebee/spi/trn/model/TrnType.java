 ...
 */
@JsonAdapter(TrnType.Adapter.class)
public enum TrnType {
  ...
  public static class Adapter extends TypeAdapter<TrnType> {
    @Override
    public void write(final JsonWriter jsonWriter, final TrnType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TrnType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TrnType.fromValue(value);
    }
  }
}
