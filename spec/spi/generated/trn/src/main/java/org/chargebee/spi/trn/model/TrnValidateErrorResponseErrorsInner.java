...
import org.chargebee.spi.trn.model.ErrorCode;
...
public class TrnValidateErrorResponseErrorsInner {
  ...
  * @throws IOException if the JSON Element is invalid with respect to TrnValidateErrorResponseErrorsInner
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrnValidateErrorResponseErrorsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrnValidateErrorResponseErrorsInner is not found in the empty JSON string", TrnValidateErrorResponseErrorsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrnValidateErrorResponseErrorsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrnValidateErrorResponseErrorsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrnValidateErrorResponseErrorsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrnValidateErrorResponseErrorsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrnValidateErrorResponseErrorsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrnValidateErrorResponseErrorsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrnValidateErrorResponseErrorsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<TrnValidateErrorResponseErrorsInner>() {
           @Override
           public void write(JsonWriter out, TrnValidateErrorResponseErrorsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrnValidateErrorResponseErrorsInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TrnValidateErrorResponseErrorsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TrnValidateErrorResponseErrorsInner
  * @throws IOException if the JSON string is invalid with respect to TrnValidateErrorResponseErrorsInner
  */
  public static TrnValidateErrorResponseErrorsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrnValidateErrorResponseErrorsInner.class);
  }

 /**
  * Convert an instance of TrnValidateErrorResponseErrorsInner to an JSON string
  *
  * @return JSON string
  */
